         ...
         <ul class="c-sidebar-nav">
            <li class="c-sidebar-nav-item">
               <a class="c-sidebar-nav-link" href="#">
                  ...
                  Home<span class="badge badge-info">NEW</span>
               </a>
            </li>
            ...
            <li class="c-sidebar-nav-item">
               <a class="c-sidebar-nav-link" href="#">
                  <svg class="c-sidebar-nav-icon">
                     <use xlink:href="assets/icons/svg/free.svg#cil-drop"></use>
                  </svg>
                  Colors
               </a>
            </li>
            <li class="c-sidebar-nav-item">
               <a class="c-sidebar-nav-link" href="#">
                  <svg class="c-sidebar-nav-icon">
                     <use xlink:href="assets/icons/svg/free.svg#cil-pencil"></use>
                  </svg>
                  Typography
               </a>
            </li>
            ...
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
               ...
               <ul class="c-sidebar-nav-dropdown-items">
                  ...
                  <li class="c-sidebar-nav-item">
                     <a class="c-sidebar-nav-link" href="#" target="_top">
                        <svg class="c-sidebar-nav-icon">
                           <use xlink:href="assets/icons/svg/free.svg#cil-bug"></use>
                        </svg>
                        Error 404
                     </a>
                  </li>
      ...
      <div class="c-wrapper c-fixed-components">
            ...
            <ul class="c-header-nav ml-auto mr-4">
               ...
               <li class="c-header-nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right pt-0">
                     ...
                     <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                           <use xlink:href="assets/icons/svg/free.svg#cil-task"></use>
                        </svg>
                        Tasks<span class="badge badge-danger ml-auto">42</span>
                     </a>
                     <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                           <use xlink:href="assets/icons/svg/free.svg#cil-comment-square"></use>
                        </svg>
         ...
         <div class="c-body">
                        ...
                        <div class="card-body">
                           <div class="d-flex justify-content-between">
                              <div>
                                 ...
                                 <div class="small text-muted">September 2021</div>
                              </div>
                              <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                                 ...
                                 <button class="btn btn-primary" type="button">
                                    <svg class="c-icon">
                                       <use xlink:href="assets/icons/svg/free.svg#cil-cloud-download"></use>
                                    </svg>
                                 </button>
                              </div>
                           </div>
                           ...
                           <div class="card">
                              <div class="card-header bg-facebook content-center">
                                 <svg class="c-icon c-icon-3xl text-white my-4">
                                    <use xlink:href="assets/icons/svg/brand.svg#cib-facebook-f"></use>
                                 </svg>
                              </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                           <div class="card">
                              <div class="card-header bg-twitter content-center">
                                 <svg class="c-icon c-icon-3xl text-white my-4">
                                    <use xlink:href="assets/icons/svg/brand.svg#cib-twitter"></use>
                                 </svg>
                              </div>
                              <div class="card-body row text-center">
                                 <div class="col">
                        ...
                        <div class="col-sm-6 col-lg-4">
                           <div class="card">
                              <div class="card-header bg-linkedin content-center">
                                 <svg class="c-icon c-icon-3xl text-white my-4">
                                    <use xlink:href="assets/icons/svg/brand.svg#cib-linkedin"></use>
                                 </svg>
                              </div>
                              <div class="card-body row text-center">
                                 <div class="col">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                       ...
                                       <div class="progress-group mb-5">
                                          <div class="progress-group-header">
                                             <svg class="c-icon progress-group-icon">
                                                <use xlink:href="assets/icons/svg/free.svg#cil-user-female"></use>
                                             </svg>
                                             <div>Female</div>
                                       ...
                                       <div class="progress-group">
                                          <div class="progress-group-header align-items-end">
                                             <svg class="c-icon progress-group-icon">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-google"></use>
                                             </svg>
                                    ...
                                    <thead class="thead-light">
                                       <tr>
                                          <th class="text-center">
                                             <svg class="c-icon">
                                                <use xlink:href="assets/icons/svg/free.svg#cil-people"></use>
                                             </svg>
                                          </th>
                                          <th>User</th>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <div class="small text-muted"><span>New</span> | Registered: Oct 1, 2021</div>
                                          </td>
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/flag.svg#cif-us"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="clearfix">
                                                <div class="float-left"><strong>50%</strong></div>
                                                <div class="float-right"><small class="text-muted">Jun 11, 2021 - Jul 10, 2021</small></div>
                                             </div>
                                             <div class="progress progress-xs">
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-cc-mastercard"></use>
                                             </svg>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <div class="small text-muted"><span>Recurring</span> | Registered: Oct 1, 2021</div>
                                          </td>
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/flag.svg#cif-br"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="clearfix">
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-cc-visa"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="small text-muted">Last login</div>
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/flag.svg#cif-in"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="clearfix">
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-cc-stripe"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="small text-muted">Last login</div>
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/flag.svg#cif-fr"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="clearfix">
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-cc-paypal"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="small text-muted">Last login</div>
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/flag.svg#cif-es"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="clearfix">
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-cc-apple-pay"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="small text-muted">Last login</div>
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/flag.svg#cif-pl"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="clearfix">
                                          ...
                                          <td class="text-center">
                                             <svg class="c-icon c-icon-xl">
                                                <use xlink:href="assets/icons/svg/brand.svg#cib-cc-amex"></use>
                                             </svg>
                                          </td>
                                          <td>
                                             <div class="small text-muted">Last login</div>
            ...
            <footer class="c-footer">
               <div><a href="https://therichpost.com.com/">Therichpost</a> © 2021 therichpost.</div>
